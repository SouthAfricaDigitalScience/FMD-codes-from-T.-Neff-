...
// 11 December 2014: KRH: Commented out sections dealing with normalisation.
// Added in the line  weight[processor] = 0.5*weightcm*weightang; to deal with normalising as in Projection.c
